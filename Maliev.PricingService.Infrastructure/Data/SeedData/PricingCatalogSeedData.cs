...
public static class PricingCatalogSeedData
{
    ...
    private static readonly Dictionary<Guid, decimal> DensityDefaults = new()
    {
        // FDM polymers
        [G("MAT_PLA")] = 1.24m,
        [G("MAT_PETG")] = 1.27m,
        ...
        [G("MAT_CF_PETG")] = 1.30m,
        // SLA/DLP resins
        [G("MAT_STD_RESIN")] = 1.17m,
        [G("MAT_TOUGH_RESIN")] = 1.15m,
        [G("MAT_FLEX_RESIN")] = 1.10m,
        [G("MAT_CAST_RESIN")] = 1.10m,
        [G("MAT_HT_RESIN")] = 1.22m,
        // SLS / MJF powders
        [G("MAT_PA12_SLS")] = 1.01m,
        [G("MAT_PA11_SLS")] = 1.03m,
        [G("MAT_PA12GF_SLS")] = 1.15m,
        [G("MAT_PA12_MJF")] = 1.01m,
        [G("MAT_PA12GB_MJF")] = 1.06m,
        // Material jetting
        [G("MAT_VEROWHITE")] = 1.17m,
        [G("MAT_VEROBLACK")] = 1.17m,
        [G("MAT_TANGOPLUS")] = 1.12m,
        // CNC metals
        [G("MAT_AL6061")] = 2.70m,
        [G("MAT_AL7075")] = 2.81m,
        [G("MAT_SS304")] = 7.93m,
        [G("MAT_SS316L")] = 8.00m,
        [G("MAT_BRASS_C360")] = 8.50m,
        [G("MAT_COPPER_C110")] = 8.96m,
        [G("MAT_TI6AL4V")] = 4.43m,
        [G("MAT_PEEK")] = 1.30m,
        [G("MAT_DELRIN")] = 1.41m,
        // DMLS metals
        [G("MAT_TI6AL4V_DMLS")] = 4.43m,
        [G("MAT_ALSI10MG")] = 2.67m,
        [G("MAT_IN718")] = 8.19m,
        [G("MAT_174PH")] = 7.78m,
        // Binder jetting
        [G("MAT_SS316L_BJ")] = 7.95m,
        [G("MAT_BRONZE_BJ")] = 7.80m,
    };
    ...
    private static IEnumerable<PricingConfiguration> GetRawPricingConfigurations() =>
    [
        // ══ CNC Machining ══════════════════════════════════════════════════════
