...
public static class PricingCatalogSeedData
{
    ...
    [
        ...
        new() { Id = G("PC_CNC_AL6061"), MaterialId = Al6061Id, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.18m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 850m,
        ...
        new() { Id = G("PC_CNC_AL7075"), MaterialId = Al7075Id, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.32m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 850m,
        ...
        new() { Id = G("PC_CNC_SS304"), MaterialId = Ss304Id, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.12m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 950m,
        ...
        new() { Id = G("PC_CNC_SS316L"), MaterialId = Ss316LId, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.15m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 950m,
        ...
        new() { Id = G("PC_CNC_BRASS"), MaterialId = BrassC360Id, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.45m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 850m,
        ...
        new() { Id = G("PC_CNC_COPPER"), MaterialId = CopperC110Id, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.55m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 950m,
        ...
        new() { Id = G("PC_CNC_TI"), MaterialId = Ti6Al4VId, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 1.20m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 1200m,
        ...
        new() { Id = G("PC_CNC_PEEK"), MaterialId = PeekId, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.85m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 750m,
        ...
        new() { Id = G("PC_CNC_DELRIN"), MaterialId = DelrinId, ManufacturingProcessId = CncId,
                MaterialPricePerCm3 = 0.35m, SupportMaterialPricePerCm3 = 0, MachineHourlyRate = 750m,
